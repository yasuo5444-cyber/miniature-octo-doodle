...
export const MAPS = {
    ...
    construction: {
        ...
        desc: '초고난도 · 거대 지그재그 힐클라임과 고속 다운힐 (약 2,100m)',
        // 겹침 현상을 막기 위해 맵을 거대하게 벌리고, 코너를 부드럽게 펼쳤습니다.
        pts: [
            [0, -350, 0],       // 1. 출발선 (가운데 아래)
            [200, -200, 4],     // 2. 우 코너 
            [-200, -50, 8],     // 3. 좌 코너 (지그재그 1) - 넓게 퍼져서 절대 겹치지 않음!
            [200, 100, 12],     // 4. 우 코너 (지그재그 2)
            [-200, 250, 16],    // 5. 좌 코너 (지그재그 3)
            [0, 400, 20],       // 6. 정상 도달 후 크게 우회전
            [400, 300, 15],     // 7. 맵 우측 바깥쪽으로 크게 도는 고속 다운힐 시작
            [450, 100, 10],     // 8. 겹칠 일 없는 우측 외곽 직선 내리막
            [400, -150, 5],     // 9. 출발선을 향해 크게 도는 코너
            [150, -350, 0]      // 10. 부드럽게 출발선 복귀
        ],
        pads: [0.15, 0.35, 0.55, 0.75, 0.9],
        jumps: [], // 공중부양 버그를 원천 차단하기 위해 억지 점프대는 제거!
        palette: {
