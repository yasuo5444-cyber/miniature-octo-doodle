...
export const MAPS = {
    ...
    construction: {
        ...
        desc: '초고난도 · 꼬임 없는 완벽한 지그재그와 초고속 다운힐 (약 2,200m)',
        // 출발선 꼬임 현상을 100% 완벽하게 해결한 좌우 분리형 설계!
        pts: [
            [0, -350, 0],       // 0. 출발선 (완벽한 평지 직선 한가운데)
            [200, -350, 0],     // 1. 첫 코너 진입 전 긴 직선
            [350, -200, 3],     // 2. 우측으로 크게 돌며 오르막 시작
            [100, -50, 6],      // 3. 지그재그 1 (좌 꺾임)
            [350, 100, 9],      // 4. 지그재그 2 (우 꺾임)
            [100, 250, 12],     // 5. 지그재그 3 (좌 꺾임)
            [250, 400, 15],     // 6. 정상 도달! (우 꺾임)
            [-100, 400, 12],    // 7. 좌측 외곽으로 크게 도는 다운힐 시작
            [-350, 200, 8],     // 8. 겹칠 일 없는 좌측 외곽 고속 다운힐
            [-350, -100, 4],    // 9. 마지막 거대 좌코너
            [-200, -350, 0]     // 10. 출발선으로 진입 (여기서부터 0번, 1번까지 완벽한 일직선!)
        ],
        pads: [0.15, 0.35, 0.55, 0.75, 0.95],
        jumps: [],
        palette: {
            sky: 0xd98f5e, fog: 0xc48052, ground: 0x5a4a3c, road: 0x3b3f45,
            curbA: 0xffd23f, curbB: 0x111111,
