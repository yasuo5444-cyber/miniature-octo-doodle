...
export const MAPS = {
  ...
  // 👇 시야를 가리는 터널을 삭제하고, 미친듯한 좌우 지그재그 코너를 때려 넣었습니다.
  construction: {
    name: '익스트림 공사장', icon: '🚧', diff: 5, cp: 18, scale: 0.9,
    desc: '초고난도 · 무한 지그재그 드리프트 · 42m 수직 낙하 (약 1,700m)',
    pts: [
      [0, -200, 0],       // 출발
      [80, -150, 2],      // 우 코너 (지그재그 오르막 시작)
      [20, -50, 8],       // 좌 코너
      [150, -20, 14],     // 우 코너
      [60, 60, 20],       // 좌 코너
      [220, 100, 26],     // 우 코너
      [120, 180, 32],     // 좌 코너
      [250, 250, 38],     // 우 코너
      [80, 300, 42],      // 좌 코너 (최고도 42m 도달 정점!)
      [-80, 250, 35],     // 좌 코너 (지그재그 내리막 시작)
      [-200, 280, 28],    // 우 코너
      [-120, 150, 20],    // 좌 코너
      [-250, 100, 12],    // 우 코너
      [-150, 0, 6],       // 좌 코너
    ...
    pads: [0.1, 0.3, 0.5, 0.7, 0.9],
    jumps: [{ pt: 8, len: 45, h: 5 }, { pt: 12, len: 40, h: 3 }], // 절벽에서 떨어지는 아찔한 점프 2회
    palette: {
